...
def category(intent_request):
    ...
    g = graph.traversal().withRemote(DriverRemoteConnection('ws://neptunedbcluster-ofnpdjqedhzt.cluster-cryiyy1ygf5o.us-east-1.neptune.amazonaws.com:8182/gremlin','g'))
...
def dispatch(intent_request):
    ...
    if intent_name == 'SelectCategoryIntent':
